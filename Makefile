###########################
# Makefile
# for BeoLingus Deutsch-Englisch v2021.09.27
# by Wolfgang Reszel
...
build:
	...
	@cd ${DICT_DEV_KIT_OBJ_DIR}/Dictionaries; zip -r "../../releases/$(DATE)/${DICT_NAME_NSPC}_dictionaryfile.zip" "$(DICT_NAME).dictionary/"
	@echo "Done."
...
notarize:
	xcrun altool --notarize-app --primary-bundle-id "de.tekl.dictionary.beolingusDeutschEnglisch.dmg" --username "tekl@mac.com" --password "@keychain:AC_PASSWORD" --file releases/$(DATE)/$(DICT_NAME_NSPC).dmg
