###########################
# Makefile
# for BeoLingus Deutsch-Englisch v2019.04.24
# by Wolfgang Reszel
...
dmg:
	...
	@mkdir releases/2019.04.24/ | true
	...
	@/Applications/DMG\ Canvas.app/Contents/Resources/dmgcanvas installer/$(DICT_NAME_NSPC).dmgCanvas releases/2019.04.24/$(DICT_NAME_NSPC).dmg -setTextString version v2019.04.24
	@open releases/2019.04.24/$(DICT_NAME_NSPC).dmg
...
notarize:
	xcrun altool --notarize-app --primary-bundle-id "de.tekl.dictionary.beolingusDeutschEnglisch.dmg" --username "tekl@mac.com" --password "@keychain:AC_PASSWORD" --file releases/2019.04.24/$(DICT_NAME_NSPC).dmg

nhistory:
	xcrun altool --notarization-history 0 -u "tekl@mac.com" -p "@keychain:AC_PASSWORD"

nstaple:
	xcrun stapler staple releases/2019.04.24/$(DICT_NAME_NSPC).dmg
