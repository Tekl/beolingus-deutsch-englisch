###########################
# Makefile
# for BeoLingus Deutsch-Englisch v2019.04.15
# by Wolfgang Reszel
...
notarize:
	xcrun altool --notarize-app --primary-bundle-id "de.tekl.dictionary.beolingusDeutschEnglisch.dmg" --username "tekl@mac.com" --password "@keychain:AC_PASSWORD" --file releases/2019.04.15/$(DICT_NAME_NSPC).dmg
