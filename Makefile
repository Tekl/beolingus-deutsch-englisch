...
notarize:
	xcrun altool --notarize-app --primary-bundle-id "de.tekl.dictionary.beolingusDeutschEnglisch.dmg" --username "tekl@mac.com" --password "@keychain:AC_PASSWORD" --file releases/2019.04.10/$(DICT_NAME_NSPC).dmg
